...
<p align="center">
  <b>MSCS @ UMN | BSc. Honors CS @ UBC | Prev TA & MLE @ UBC</b><br>
...
*FastAPI, PyTorch, SciKit-Learn, Pandas, NumPy, MatPlotLib*

- Built a multi-strategy simulator combining technical signals, RSS-driven sentiment, and regime detection; hybrid clustering + logistic regression improved regime classification **+34%**.
- Designed a CNN-LSTM with RL-driven position sizing, raising directional accuracy **+12%** and boosting backtested returns **+30%** over baseline.

#### 🛡️ Disagreement-Aware RAG (Answer/Abstain)
*FastAPI, LlamaIndex, Next.js, Hugging Face Transformers, Weights & Biases*

- Built an abstaining RAG with a lightweight logistic-regression gate over self-consistency variance, ROUGE-L–style evidence overlap, and token-level entropy; instrumented with W&B.
- Reached ~97% coverage at ~3–4% hallucination; shipped a Next.js UI to visualize coverage↔hallucination trade-offs and added a zero-shot BART-MNLI entailment auditor to flag risky answers.

#### 🧭 Structured Alignment LM — Plan-First LLM (LoRA SFT + mini-PPO)
*PyTorch, HF Transformers/TRL/PEFT, FastAPI, Next.js/TypeScript, CUDA*
